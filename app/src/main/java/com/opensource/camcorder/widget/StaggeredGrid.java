 ...
 *
 * <p>
 * You may keep view {@link com.opensource.camcorder.widget.StaggeredGrid.Location} inside StaggeredGrid as much
 ...
 * list of tens of thousands of {@link com.opensource.camcorder.widget.StaggeredGrid.Location}s which will be
...
abstract class StaggeredGrid {
    ...
    /**
     * Sets the {@link com.opensource.camcorder.widget.StaggeredGrid.Provider} for this staggered grid.
     *
    ...
    /**
     * Sets the array of {@link com.opensource.camcorder.widget.StaggeredGrid.Row}s to fill into. For views that represent a
     * horizontal list, this will be the rows of the view. For views that
     * represent a vertical list, this will be the columns.
     *
     * @param row The array of {@link com.opensource.camcorder.widget.StaggeredGrid.Row}s to be filled.
     */
    ...
    /**
     * Returns the size of the saved {@link com.opensource.camcorder.widget.StaggeredGrid.Location}s.
     */
    ...
    /**
     * Returns the {@link com.opensource.camcorder.widget.StaggeredGrid.Location} at the given index.
     */
